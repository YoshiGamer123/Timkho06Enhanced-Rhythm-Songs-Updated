if (song_menu)
{
    ...
    if (down_p())
    {
        if (selection < (array_length(tracklist) - 1))
            selection++;
    ...
    if (button2_p())
    {
        ...
        if (room == room_rhythmgame_editor)
        {
        ...
        else
        {
            ...
            instance_destroy(obj_rhythmgame_editor);
        }
    }
...
if (song_initialized == 1)
{
    ...
    else if (savecon == 0 && keyboard_check_pressed(ord("R")))
    {
    ...
    else if (savecon == 1)
    {
        ...
        {
            scr_rhythmgame_editor_save(savestring + "_hard.txt");
            scr_rhythmgame_editor_save("SongCharts/" + savestring + "_hard.txt");
            savecon = 2;
            load_source = 2;
        }
    }
    else if (savecon == -1)
    {
        ...
        {
            if (file_exists(savestring + ".txt") || file_exists("SongCharts/" + savestring + ".txt"))
            {
                scr_rhythmgame_clear_notes();
                
                if (file_exists("SongCharts/" + savestring + ".txt"))
                    scr_rhythmgame_editor_load("SongCharts/" + savestring + ".txt");
                else if (file_exists(savestring + ".txt"))
        ...
        {
            if (file_exists(savestring + "_hard.txt") || file_exists("SongCharts/" + savestring + "_hard.txt"))
            {
                scr_rhythmgame_clear_notes();
                
                if (file_exists("SongCharts/" + savestring + "_hard.txt"))
                    scr_rhythmgame_editor_load("SongCharts/" + savestring + "_hard.txt");
                else if (file_exists(savestring + "_hard.txt"))
                    scr_rhythmgame_editor_load(savestring + "_hard.txt");
        ...
        {
            if (file_exists(savestring + "_autosave.txt") || file_exists("SongCharts/" + savestring + "_autosave.txt"))
            {
                scr_rhythmgame_clear_notes();
                
                if (file_exists("SongCharts/" + savestring + "_autosave.txt"))
                    scr_rhythmgame_editor_load("SongCharts/" + savestring + "_autosave.txt");
                else if (file_exists(savestring + "_autosave.txt"))
