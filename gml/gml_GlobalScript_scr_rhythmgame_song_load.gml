...
function scr_rhythmgame_song_select(arg0)
{
    ...
    if (arg0 >= 5 && file_exists("SongCharts/music_timing_customsong_info" + string(arg0 - 4) + ".txt"))
    {
        song_id = 6 + arg0;
        vinyl_id = 1;
        var _file = file_text_open_read("SongCharts/music_timing_customsong_info" + string(arg0 - 4) + ".txt");
        var l_arg = [];
        var line_ind = 0;
...
function scr_rhythmgame_rank_scores(arg0, arg1 = 0)
{
    ...
    if (arg0 >= 11 && file_exists("SongCharts/music_timing_customsong_info" + string(arg0 - 10) + ".txt"))
    {
...
function scr_rhythmgame_load_events(arg0)
{
    ...
    else if (arg0 >= 11 && file_exists("SongCharts/music_timing_customsong_events" + string(arg0 - 10) + ".txt"))
    {
        drums.auto_play = 1;
        var _file = file_text_open_read("SongCharts/music_timing_customsong_events" + string(arg0 - 10) + ".txt");
