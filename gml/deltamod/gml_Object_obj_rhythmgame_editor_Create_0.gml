...
quickscroll_timer = 0;
arrow_scroll = 0;
ralsei = instance_create(camerax() + 420, 300, obj_rhythmgame_performer);
...
ralsei.rhythmer = id;
susie = instance_create(camerax() + 120, 300, obj_rhythmgame_performer);
...
susie.animspeed = 3;
susie.rhythmer = id;
kris = instance_create(camerax() + 220, 300, obj_rhythmgame_performer);
...
function load_chart()
{
    ...
    {
        savestring += ("_customsong" + string(song_id - 10));
        scr_debug_print("loading custom song");
    }
    else
    {
    ...
    if (file_exists(savestring + "_autosave.txt"))
    {
    ...
    else if (file_exists(program_directory + "/SongCharts/" + savestring + "_autosave.txt"))
    {
        scr_rhythmgame_editor_load(program_directory + "/SongCharts/" + savestring + "_autosave.txt");
        has_file = true;
        load_source = 1;
    }
    else if (file_exists(program_directory + "/SongCharts/" + savestring + ".txt"))
    {
        scr_rhythmgame_editor_load(program_directory + "/SongCharts/" + savestring + ".txt");
        has_file = true;
        load_source = 1;
    }
    else
