if (i_ex(obj_room_castle_tv_rhythm) && obj_room_castle_tv_rhythm.AlbumArg == -1 && file_exists(program_directory + "/SongCharts/AlbumsInfo.txt"))
{
    var _file = file_text_open_read(program_directory + "/SongCharts/AlbumsInfo.txt");
    var l_arg = [];
    var l_ind = 0;
    AlbumArg = [];
...
if (init == 0)
{
    ...
    if (type == 6)
    {
        ...
        if (!file_exists(program_directory + "/SongCharts/AlbumsInfo.txt"))
        {
            menu = 1;
...
if (type == 6)
{
    ...
    if (menu == 1)
    {
        ...
        if (button2_p() && file_exists(program_directory + "/SongCharts/AlbumsInfo.txt"))
        {
            menuCoord[1] = menuCoord[0];
