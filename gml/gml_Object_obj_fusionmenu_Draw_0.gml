...
if (type == 6 && init == 1)
{
    if (menu == 0)
    {
        draw_set_font(fnt_mainbig);
        draw_set_color(c_ltgray);
        draw_text_transformed(xx + 480, 280, stringsetloc("Page ", "obj_fusionmenu_slash_Draw_0_gml_171_0") + string((floor(menuScrollCurrent[0]) / 5) + 1) + " / " + string(ceil(menuMaximumID[0] / 5)), 1, 1, 0);
        tickerTimer = 0;
        scr_84_set_draw_font("dotumche");
        draw_text_transformed(xx + 440, 320, stringsetloc("Left / Right: \nChange Pages.", "obj_fusionmenu_slash_Draw_0_gml_181_0"), 1, 1, 0);
        draw_text_transformed(xx + 440, 355, "[Z] Select Album.\n[X] Cancel.", 1, 1, 0);
    }
    ...
    if (menu == 1)
    {
        draw_set_font(fnt_mainbig);
        draw_set_color(c_ltgray);
        draw_text_transformed(xx + 480, 280, stringsetloc("Page ", "obj_fusionmenu_slash_Draw_0_gml_171_0") + string((floor(menuScrollCurrent[1]) / 5) + 1) + " / " + string(ceil(menuMaximumID[1] / 5) + 1), 1, 1, 0);
        tickerTimer++;
        scr_84_set_draw_font("dotumche");
        draw_text_transformed(xx + 440, 375, stringsetloc("Left / Right: \nChange Pages.", "obj_fusionmenu_slash_Draw_0_gml_181_0"), 1, 1, 0);
        ossafe_fill_rectangle_color(xx + 440, yy + 70, xx + 440 + 175, yy + 70 + 175, c_black, c_black, c_black, c_black, false);
        draw_set_color(c_white);
        ossafe_fill_rectangle(xx + 440, yy + 70, xx + 440 + 175, yy + 70 + 175, true);
        
        if (dojoEncounterAmbush[dojoEncounter[menuCoord[1]]] != undefined)
            draw_sprite(dojoEncounterAmbush[dojoEncounter[menuCoord[1]]], -1, xx + 440, yy + 71);
        
        draw_text_transformed(xx + 440, 410, "[Z] Normal Diff.\n[C] Hard Diff.\n[X] Cancel.", 1, 1, 0);
        var tempSongName = songName[dojoEncounter[menuCoord[1]]] + "    ";
        var songNameLength = string_length(tempSongName);
        var tickerSongName;
        ...
        {
            var tickerCount = max(0, floor((tickerTimer - 60) / 3)) % songNameLength;
            var tickerSongNamePrep = tempSongName + songName[dojoEncounter[menuCoord[1]]];
            tickerSongName = string_copy(tickerSongNamePrep, 1 + tickerCount, 20);
        }
        else
        {
        ...
        draw_set_color(c_lime);
        draw_text_transformed(xx + 440, 320, stringsetloc("Now Playing", "obj_fusionmenu_slash_Draw_0_gml_194_0"), 1, 1, 0);
        draw_text_transformed(xx + 440, 345, tickerSongName, 1, 1, 0);
    }
}
