...
if (BGSprite == -1 && file_exists("SongAlbums/rhythm_custom_bg.png"))
    BGSprite = sprite_add("SongAlbums/rhythm_custom_bg.png", 0, false, false, false, true, 0, 0);
...
if (palette_active)
{
    ...
    if (file_exists("SongAlbums/rhythm_custom_bg.png"))
        draw_sprite_ext(BGSprite, 1, x, y + 100, image_xscale, image_yscale, image_angle, image_blend, image_alpha);
    else
...
else
{
    if (file_exists("SongAlbums/rhythm_custom_bg.png"))
    {
        ...
        draw_sprite_ext(BGSprite, 1, x, y + 100, image_xscale, image_yscale, image_angle, image_blend, 0.1 + (sin(bg_timer / 6) * 0.1 * (kchart_ease * 0.65)));
    }
    else
    {
