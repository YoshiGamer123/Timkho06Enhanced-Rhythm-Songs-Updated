...
function scr_rhythmgame_songlist()
{
    ...
    else
    {
        ...
        {
            dojoEncounterAmbush[0] = sprite_add("SongAlbums/customalbum1.png", 0, false, false, false, true, 0, 0);
            dojoEncounterAmbush[1] = sprite_add("SongAlbums/customalbum2.png", 0, false, false, false, true, 0, 0);
            dojoEncounterAmbush[2] = sprite_add("SongAlbums/customalbum3.png", 0, false, false, false, true, 0, 0);
            dojoEncounterAmbush[3] = sprite_add("SongAlbums/customalbum4.png", 0, false, false, false, true, 0, 0);
            dojoEncounterAmbush[4] = sprite_add("SongAlbums/customalbum5.png", 0, false, false, false, true, 0, 0);
            dojoFlag[0] = 0;
            dojoFlag[1] = 1;
            dojoFlag[2] = 2;
            dojoFlag[3] = 3;
        ...
        {
            if (file_exists("SongCharts/music_timing_customsong_info" + string(i - 4) + ".txt"))
            {
                var _file = file_text_open_read("SongCharts/music_timing_customsong_info" + string(i - 4) + ".txt");
                var l_arg = [];
                var line_ind = 0;
                ...
                try
                {
                    if (array_length(dojoEncounterAmbush) < (CustomID + 1))
                        dojoEncounterAmbush[CustomID] = sprite_add("SongAlbums/" + l_arg[11] + ".png", 0, false, false, false, true, 0, 0);
                }
                catch (_exception)
                {
